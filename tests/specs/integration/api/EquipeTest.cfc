...
component extends="coldbox.system.testing.BaseTestCase" appMapping="/"{
	...
	function run(){
		...
		describe( "api/Equipe Suite", function(){
			...
			it( "index", function(){
				...
				var event = get( "api.Equipe.index" );
			...
			it( "create", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "api.Equipe.create" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
			...
			it( "update", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "api.Equipe.update" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
			...
			it( "delete", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "api.Equipe.delete" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
