...
component extends="coldbox.system.testing.BaseTestCase" appMapping="/"{
	...
	function run(){
		...
		describe( "api/Teams2 Suite", function(){
			...
			it( "index", function(){
				...
				var event = get( "api.Teams2.index" );
			...
			it( "create", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "api.Teams2.create" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
			...
			it( "update", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "api.Teams2.update" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
			...
			it( "delete", function(){
                // Execute event or route via GET http method. Spice up accordingly
				var event = get( "api.Teams2.delete" );
				// expectations go here.
				expect( false ).toBeTrue();
			});
